...
function TopBar() {
  ...
  return (
    <header>
      <svg className="icon-user-avatar" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {username ? (
        ...
        <div className="btn btn-logout" onClick={login}>Login</div>
      )}
    </header>
  );
}
